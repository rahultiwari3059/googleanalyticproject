...
public class jsonreader {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Object obj = parser.parse(new FileReader("/home/bridgeit/Desktop/springexp/HelloAnalytics/Updateversion8.JSON"));
...
int p=0;
		try {
			...
			File file = new File("/home/bridgeit/Music/Updateversion8.csv");
